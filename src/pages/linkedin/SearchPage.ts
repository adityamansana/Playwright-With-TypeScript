...
export class SearchPage extends BasePage {
  ...
  private readonly FEED_CONTAINER = 'div.scaffold-layout__main, div[data-view-name="feed-full-page"], main';
  private readonly CREATE_POST_BTN = 'button.share-box-feed-entry__trigger, button[aria-label*="post"]';
  private readonly SEARCH_INPUT = [
