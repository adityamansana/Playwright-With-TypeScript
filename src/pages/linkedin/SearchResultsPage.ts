...
export class SearchResultsPage extends BasePage {
  ...
  private readonly RESULTS_LIST =
    'ul.reusable-search__entity-result-list, div.search-results-container ul, ul[role="list"]';
  private readonly RESULT_ITEMS =
    'li.reusable-search__result-container, li.artdeco-list__item';
